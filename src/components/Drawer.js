...
function StonksDrawer(props) {
    const classes = useStyles();
    const theme = useTheme();
    const [open, setOpen] = useState(false);
    const {children, updateCurrentScreenIndex} = props;
...
const mapDispatchToProps = dispatch => {
    return {
        updateCurrentScreenIndex: (index) => {
            dispatch(updateCurrentScreenIndex(index));
        }    
    }
};

export default connect(null, mapDispatchToProps)(StonksDrawer);